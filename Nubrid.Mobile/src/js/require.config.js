...
(function () {
	...
	function _getPath(localPath, cdnPath, minSeparator, noSourceMap) {
		return (window.phonegap ? localPath : document.location.protocol + cdnPath)
	...
	require.config({
		...
		, paths: {
			...
			, "react": _getPath("libs/react/react", "//fb.me/react-with-addons-0.14.3", null, true)
			, "react.dom": _getPath("libs/react/react.dom", "//fb.me/react-dom-0.14.3", null, true)
