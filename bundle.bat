...
REM call npm run -s modernizr -- -c modernizr-config.json -d src/js/libs/modernizr.min.js
...
REM call npm run -s babel -- node_modules/immutable-backbone/index.js -o src/js/libs/backbone/backbone.immutable.js
...
REM move /Y .\src\js\libs\react\subschema.js .\src\js\libs\react\subschema.min.js
...
REM call npm run -s download -- --out src/js/libs/backbone/ https://raw.githubusercontent.com/noveogroup/backbone.iobind/master/dist/backbone.iobind.js
REM call npm run -s download -- --out src/js/libs/backbone/ https://raw.githubusercontent.com/noveogroup/backbone.iobind/master/dist/backbone.iosync.js
REM call npm run -s download -- https://raw.githubusercontent.com/magalhas/backbone-react-component/master/dist/backbone-react-component.js > src/js/libs/backbone/backbone.react.js
REM call npm run -s download -- https://raw.githubusercontent.com/magalhas/backbone-react-component/master/dist/backbone-react-component-min.js > src/js/libs/backbone/backbone.react-min.js
REM call npm run -s download -- --out src/js/libs/require/ https://raw.githubusercontent.com/requirejs/text/latest/text.js
...
REM call npm run -s uglifyjs -- src/js/libs/backbone/backbone.immutable.js -o src/js/libs/backbone/backbone.immutable.min.js -p relative -c -m --source-map
REM call npm run -s uglifyjs -- src/js/libs/backbone/backbone.pouchdb.js -o src/js/libs/backbone/backbone.pouchdb.min.js -p relative -c -m --source-map
...
REM call npm run -s uglifyjs -- src/js/libs/backbone/backbone.iobind.js -o src/js/libs/backbone/backbone.iobind.min.js -p relative -c -m --source-map
:: --source-map src/js/libs/backbone/backbone.iobind.map
REM call npm run -s uglifyjs -- src/js/libs/backbone/backbone.iosync.js -o src/js/libs/backbone/backbone.iosync.min.js -p relative -c -m --source-map
