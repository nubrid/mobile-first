...
set arg=npm run -s replace -- "^\n\.icon \{" ".ui-nosvg [class*=""ui-icon-""]::after {" dist/jquery.mobile/dist/css/jquery.mobile.icons.png.css && call run arg
...
set arg=npm run -s replace -- "^\.svg \{" "[class*=""ui-icon-""]::after {" dist/jquery.mobile/dist/css/jquery.mobile.icons.svg.css && call run arg
